...
public class AdvOAPreferenceDialogTest extends JPanel implements ActionListener {
	...
	public AdvOAPreferenceDialogTest() {
		...
		bubble.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				// OAAlertPlugin.this.setPluginEnabled(false);
			}
		});
		JLabel lLanguage = new JLabel();

		alertEnabled.addActionListener(this);
		// oauserField.setHorizontalAlignment(150);
		// passwordField.setHorizontalAlignment(150);
		...
		setPanel.add(bubble, new GridBagConstraints(0, 2, 2, 1, 1.0, 1.0,
				GridBagConstraints.NORTHWEST, GridBagConstraints.NONE,
				new Insets(5, 5, 5, 5), 0, 0));
		// spellPanel.add(lLanguage, new GridBagConstraints(0, 2, 1, 1, 1.0,
		// 1.0, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new
		// Insets(5, 5, 5, 5), 0, 0));
		// spellPanel.add(showLanguages, new GridBagConstraints(0, 3, 2, 1, 1.0,
		// 1.0, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new
		// Insets(5, 5, 5, 5), 0, 0));
		// spellPanel.add(ignoreCase, new GridBagConstraints(0, 4, 2, 1, 1.0,
		// 1.0, GridBagConstraints.NORTHWEST, GridBagConstraints.NONE, new
		// Insets(5, 5, 5, 5), 0, 0));

		// Setup MNEMORICS
		// oauserField.setMaximumSize(new Dimension(100, 20));
